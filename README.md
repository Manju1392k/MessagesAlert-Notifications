...
# MessagesAlert-Notifications

### The most effective way to create website notifications using HTML, CSS, and Javascript. 

### **The primary goal of this project is to construct the logic.**
...
```bash
git clone https://github.com/Manju1392k/MessagesAlert-Notifications.git
```
